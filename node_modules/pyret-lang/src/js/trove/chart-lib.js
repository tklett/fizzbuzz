({
  ...
  theModule: function (RUNTIME, NAMESPACE, uri, IMAGELIB, jsnums , GoogleChartsNode) {
  'use strict';

  console.log(GoogleChartsNode);
  return RUNTIME.pauseStack(async function (restarter) {
    const result = await GoogleChartsNode.render(renderChart, { headless: "new" });
    function renderChart() {
      console.log("Rendering");
      console.log(google);
      restarter.resume(google);
    }
    // Load google library via editor.html to avoid loading issues
  })
  var google = GoogleChartsNode;
